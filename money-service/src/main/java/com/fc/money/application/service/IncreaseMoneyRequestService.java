...
import com.fc.common.CountDownLatchManager;
import com.fc.common.RechargingMoneyTask;
import com.fc.common.SubTask;
...
public class IncreaseMoneyRequestService implements IncreaseMoneyRequestUseCase {
    ...
    private final SendRechargingMoneyTaskPort rechargingMoneyTaskPort;
    ...
    public MoneyChangingRequest increaseMoneyRequestAsync(IncreaseMoneyRequestCommand command) {
        ...
        // Amount Money Firmbanking     --> Ok 받았다고 가정. (SKip)
